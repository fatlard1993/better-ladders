 ...
 * by rung down a shaft you cannot see the bottom of, and no guessing how deep the shaft was. The
 * pieces leave the hand on the click; the rungs take their time getting down.
 *
...
public class RopeLadderItem extends BlockItem {
	...
	public InteractionResult useOn(UseOnContext context) {
		...
		int thrown = RopeLadder.throwDown(serverLevel, start, facing, stack.getCount());
